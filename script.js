(function(){
  ...
  const translations = {
    ar: {
      ...
      heroTitle: "شركة <span>نال التشييد</span> للمقاولات المعمارية",
      ...
      f1Q: "ما هي الخدمات التي تقدمها شركة نال التشييد؟",
      f1A: "تقدم شركة نال التشييد خدمات المقاولات المعمارية العامة، والتشييد البنائي، والحلول الهندسية المتكاملة، إلى جانب إدارة وتأجير معدات التشييد البنائي.",
      f2Q: "أين تعمل شركة نال التشييد في السعودية؟",
      ...
      rights: "جميع الحقوق محفوظة © شركة نال التشييد للمقاولات المعمارية"
    },
    en: {
      brand: "Nal Al Tsheed",
      aboutNav: "About Us",
